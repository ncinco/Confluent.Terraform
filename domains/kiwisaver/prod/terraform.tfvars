...
cluster_name = "kiwisaver_cluster_prod"
...
topics = [
    { name = "growth", partitions_count = 10, cleanup_policy = "delete"},
    { name = "conservative", partitions_count = 10, cleanup_policy = "delete"},
    { name = "batman", partitions_count = 10, cleanup_policy = "delete"}
  ]