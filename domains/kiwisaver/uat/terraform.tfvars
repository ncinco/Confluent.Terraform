...
cluster_name = "kiwisaver_cluster_uat"
environment = "kiwisaver_uat"
cluster_cloud = "AZURE"
cluster_region = "australiaeast"

# topic related variables
topics = [
    { name = "growth", partitions_count = 3, cleanup_policy = "delete"},
    { name = "conservative", partitions_count = 3, cleanup_policy = "delete"},
