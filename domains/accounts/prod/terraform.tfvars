...
cluster_name = "accounts_cluster_prod"
...
topics = [
    { name = "accounts", partitions_count = 10, cleanup_policy = "delete"},
    { name = "transactions", partitions_count = 10, cleanup_policy = "delete"},
    { name = "superman", partitions_count = 10, cleanup_policy = "delete"}
  ]